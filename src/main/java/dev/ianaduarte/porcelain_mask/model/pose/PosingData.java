...
public record PosingData(PoseSet inMainhand, PoseSet inOffhand) {
	...
	public record PoseSet(boolean hideOther, ArmPose mainhand, ArmPose offhand, ArmPose item, ArmPose mainhandSwing, ArmPose offhandSwing) {
		public static PoseSet EMPTY = new PoseSet(false, ArmPose.EMPTY, ArmPose.EMPTY, ArmPose.EMPTY, ArmPose.EMPTY, ArmPose.EMPTY);
		...
		public static final Codec<PoseSet> CODEC = RecordCodecBuilder.create(
			instance -> instance.group(
				...
				ArmPose.CODEC.optionalFieldOf("mainhand_swing", ArmPose.EMPTY).forGetter(PoseSet::mainhandSwing),
				ArmPose.CODEC.optionalFieldOf("offhand_swing", ArmPose.EMPTY).forGetter(PoseSet::offhandSwing)
		...
		public static final StreamCodec<ByteBuf, PoseSet> STREAM_CODEC = StreamCodec.composite(
			...
			ArmPose.STREAM_CODEC, PoseSet::mainhandSwing,
			ArmPose.STREAM_CODEC, PoseSet::offhandSwing,
			PoseSet::new
		);
